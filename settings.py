# Django settings for bill_anarchy project.
...
DATABASE_NAME = 'bill_anarchy.sqlite'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'r18(s#v8#fl6!=-^%ithz6uh86f&ai4pdjp$3mhx-@@o+s5d(_'
